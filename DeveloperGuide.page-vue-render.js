...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves the entire mentorstack.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Individual command knows how to undo/redo by\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the person being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("4a. Required information is missing.\n"),_c('ul',[_c('li',[_v("4a1. System shows an error message.")]),_v(" "),_c('li',[_v("4a2. System prompts the tutor to enter the missing information. Use case resumes at step 3.")])])]),_v(" "),_c('li',[_v("4b. Information input format is invalid.\n"),_c('ul',[_c('li',[_v("4b1. System shows an error message.")]),_v(" "),_c('li',[_v("4b2. System prompts the tutor to enter information. Use case resumes at step 3.")])])]),_v(" "),_c('li',[_v("4c. A student’s information already exists.\n"),_c('ul',[_c('li',[_v("4c1. System shows an error message.")]),_v(" "),_c('li',[_v("4c2. System prompts the tutor to add a new student or update the existing student. Use case resumes at step 3.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. Students is not in the list.\n"),_c('ul',[_c('li',[_v("2a1. Mentorstack shows an error message.")])])]),_v(" "),_c('li',[_v("2b. A student is already archived.\n"),_c('ul',[_c('li',[_v("2b1. Mentorstack shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. Students is not in the list.\n"),_c('ul',[_c('li',[_v("2a1. Mentorstack shows an error message.")])])]),_v(" "),_c('li',[_v("2b. A student is already unarchived.\n"),_c('ul',[_c('li',[_v("2b1. Mentorstack shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. Student is not in the list.\n"),_c('ul',[_c('li',[_v("2a1. Mentorstack shows an error message.")])])]),_v(" "),_c('li',[_v("2b. Student is archived.\n"),_c('ul',[_c('li',[_v("2b1. Mentorstack shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. Student is not in the list.\n"),_c('ul',[_c('li',[_v("2a1. Mentorstack shows an error message.")])])]),_v(" "),_c('li',[_v("2b. Student is archived.\n"),_c('ul',[_c('li',[_v("2b1. Mentorstack shows an error message.")])])]),_v(" "),_c('li',[_v("2c. Student is not enrolled in the subject\n"),_c('ul',[_c('li',[_v("2c1. Mentorstack shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 22:42:28 GMT+8]")])])])}
}];
